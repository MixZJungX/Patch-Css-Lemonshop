      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        <div className="text-center space-y-6 pt-12 px-4">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center shadow-2xl">
              <Sparkles className="w-10 h-10 text-white" />
            </div>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 bg-clip-text text-transparent leading-tight">
            เว็บไซต์แลกโค้ด
          </h1>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Robux และไก่ตัน
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 px-4">
          ...
          <Card className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300 hover:scale-105">
            <CardHeader className="text-center p-6">
              ...
              <CardTitle className="text-2xl md:text-3xl text-white font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                แลกโค้ด Robux
              </CardTitle>
            </CardHeader>
